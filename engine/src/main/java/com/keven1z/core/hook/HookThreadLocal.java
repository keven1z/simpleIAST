...
public class HookThreadLocal {
     ...
     */
    public static final ThreadLocal<Boolean> enableHookLock = ThreadLocal.withInitial(() -> false);
    /**
     * 当前请求上报漏洞list
     */
    public static final ThreadLocal<List<SingleFindingData>> SINGLE_FINDING_THREADLOCAL = ThreadLocal.withInitial(ArrayList::new);
    /**
     * 请求开始节点
     */
    public static final ThreadLocal<Boolean> isRequestStart = ThreadLocal.withInitial(() -> false);
    /**
     * 请求结束标志
     */
    public static final ThreadLocal<Boolean> isRequestEnded =ThreadLocal.withInitial(() -> false);
     ...
     * 最大同时检测set
     */
    public static final  Set<String> DETECT_LIMIT_SET = Collections.synchronizedSet(new HashSet<>());
