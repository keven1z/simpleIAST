...
import static com.keven1z.core.hook.asm.structure.PrimitiveClassStructure.mappingPrimitiveByJavaClassName;
    ...
    private Access fixAccess() {
        ...
        this.classReader.accept(new ClassVisitor(ASM7) {
            ...
            public void visitInnerClass(String name, String outerName, String innerName, int access) {
                if (org.apache.commons.lang3.StringUtils.equals(name, internalClassName)) {
...
//            = CacheBuilder.newBuilder().maximumSize(1024).build();
    ...
    private ClassStructure newInstance(final String javaClassName) {
        ...
        final ClassStructure existClassStructure = classStructureCache.get(pair);
        ...
        protected List<BehaviorStructure> initialValue() {
            ...
            accept(new ClassVisitor(ASM7) {
                ...
                public MethodVisitor visitMethod(final int access,
                    ...
                    if (org.apache.commons.lang3.StringUtils.equals("<clinit>", name)) {
