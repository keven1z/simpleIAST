 ...
 */
public class IASTDailyRollingFileAppender extends FileAppender {
    ...
    IASTRollingCalendar rc = new IASTRollingCalendar();
     ...
     */
    public IASTDailyRollingFileAppender() {
    }

    /**
     * Instantiate a <code>IASTDailyRollingFileAppender</code> and open the
     * file designated by <code>filename</code>. The opened filename will
     * become the ouput destination for this appender.
     */
    public IASTDailyRollingFileAppender(Layout layout, String filename,
    ...
    int computeCheckPeriod() {
        IASTRollingCalendar rollingCalendar = new IASTRollingCalendar(gmtTimeZone, Locale.getDefault());
    ...
    /**
     * This method differentiates IASTDailyRollingFileAppender from its
     * super class.
     *
...
/**
 * IASTRollingCalendar is a helper class to IASTDailyRollingFileAppender.
 * Given a periodicity type and the current time, it computes the
 * start of the next interval.
 */
class IASTRollingCalendar extends GregorianCalendar {
    private static final long serialVersionUID = -1788133458110660402L;

    int type = IASTDailyRollingFileAppender.TOP_OF_TROUBLE;

    IASTRollingCalendar() {
        super();
    }

    IASTRollingCalendar(TimeZone tz, Locale locale) {
        super(tz, locale);
    }
    ...
    public Date getNextCheckDate(Date now) {
        ...
        switch (type) {
            case IASTDailyRollingFileAppender.TOP_OF_MINUTE:
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                this.add(Calendar.MINUTE, 1);
                break;
            case IASTDailyRollingFileAppender.TOP_OF_HOUR:
                this.set(Calendar.MINUTE, 0);
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                this.add(Calendar.HOUR_OF_DAY, 1);
                break;
            case IASTDailyRollingFileAppender.HALF_DAY:
                this.set(Calendar.MINUTE, 0);
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                ...
                break;
            case IASTDailyRollingFileAppender.TOP_OF_DAY:
                this.set(Calendar.HOUR_OF_DAY, 0);
                this.set(Calendar.MINUTE, 0);
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                ...
                break;
            case IASTDailyRollingFileAppender.TOP_OF_WEEK:
                ...
                break;
            case IASTDailyRollingFileAppender.TOP_OF_MONTH:
