...
public class SimpleIASTSpyManager {
    ...
    public static void $_arrayTaint(Object arrayObject, int index, Object arrayValue, String className, String method, String desc) {
        try {
            taintSpy.$_arrayTaint(arrayObject, index, arrayValue, className, method, desc);
        } catch (Throwable ignored) {
        }
    }
